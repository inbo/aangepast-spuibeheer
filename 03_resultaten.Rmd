...
```{r}
Ijzer<-clean_ijzer_and_va(file="./data/spuibeheer/extern/verwerkt_in_excel/os_Ijzer_2023.xlsx",
                   skip=7,
                   datum=1,
                   tijd=2,
                   opmerking=14,
                   site="Ijzer")
VA<-clean_ijzer_and_va(file="./data/spuibeheer/extern/verwerkt_in_excel/os_VA_2023.xlsx",
                   skip=6,
                   datum=1,
                   tijd=2,
                   opmerking=8,
...
```{r}
tos.summary %>% kable(caption="Beleidstabel voor het omgekeer spuibeheer (os) in het afleidingskanaal van de Leie (AKL), Ijzer, kanaal Gent-Oostende (KGO), Leopoldskanaal (LK) en Noordede (NE) met inschatting van het aantal glasaal dat de betreffende sluizen kon passeren dankzij os.") 
```
