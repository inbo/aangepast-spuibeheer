...
In het KGO werd er glasaal binnen gelaten vanaf 6 maart tot 5 mei. Het aangepast spuibeheer duurde in totaal 7685 minuten wat slechts iets meer is dan de helft van de duur van 2022 (14700 minuten). In 2021 werd er echter slechts 3240 minuten aangepast spuibeheer uitgevoerd. Net als in 2022 doen er zich ter hoogte van Sas Slijkens al pieken voor nog voor de aanvang van het aangepast spuibeheer (Fig. \@ref(fig:plotctdkgo) en \@ref(fig:plotkgoss)). Pieken tijdens het aangepast spuibeheer lijken wel overeen te komen met momenten van intensiever aangepast spuibeheer, maar dit kan niet sluitend gelinkt worden aan het aangepast spuibeheer. Ter hoogte van Plassendale (Fig. \@ref(fig:plotkgop)) en Brugge (Fig. \@ref(fig:plotkgob)) lijken dezelfde trends zich min of meer voor te doen maar met veel minder uitgesproken pieken. Het feit dat de pieken in geleidbaarheid optreden nog voordat de periode van aangepast spuibeheer begint, en dat deze pieken tot relatief diep in het binnenland worden waargenomen, suggereert dat er **geen verband is tussen de waargenomen geleidbaarheid en het aangepaste spuibeheer in het KGO.**
