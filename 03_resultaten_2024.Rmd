...
In 2024 werd er in het AKL maar op zeven dagen aan aangepast spuibeheer gedaan. Dit is een verdubbeling van het aantal dagen in 2022 en één dag meer dan in 2022 maar nog steeds veel minder dan de 29 dagen in 2021. In totaal stonden de sluizen 39 uur open (in 2023, 2022 en 2021 waren de sluizen 38, 19 en 464 uur open). Wegens het beperkt aantal uren spuibeheer op het AKL in 2024, kan het **aangepast spuibeheer geen wezenlijke invloed hebben op de geleidbaarheid dit jaar** thv Ramskapelle en Moerkerke. Ondanks het feit dat de limietwaarde (0.87 mS/cm) meerdere malen in Ramskapelle werd overschreden tijdens de periode van aangepast spuibeheer, leken deze overschrijdingen niet per se te volgen op momenten van aangepast spuibeheer. In Moerkerke werd de limietwaarde nooit overschreden. In de zomer en het najaar worden hogere waarden voor de geleidbaarheid geobserveerd waarbij de limietwaarde meerdere keren wordt overschreden voor zowel Moerkerke als Ramskapelle (Fig. \@ref(fig:plotctdakl)). Linken met debiet of neerslag lijken er niet te zijn (Fig. \@ref(fig:plotaklr)).
