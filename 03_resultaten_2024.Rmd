...
De inschattingen geven aan dat in **2024, 671.014 glasalen** voordeel hebben ondervonden van het aangepast spuibeheer tijdens hun stroomopwaartse m
...
p.list<-process_ctd_for_plotting(date.min=as.POSIXct("2024-03-01 00:00:00", tz="GMT"), date.max=as.POSIXct("2024-05-15 00:00:00", tz="GMT"))

source("./code/functions/f.process_conductiviteit_series_for_plotting.R")
cond.list<-process_conductiviteit_series_for_plotting(date.min=as.POSIXct("2024-03-01 00:00:00", tz="GMT"), date.max=as.POSIXct("2024-05-15 00:00:00", tz="GMT"))

source("./code/functions/f.process_ctd_series_for_plotting.R")
ctd.list<-process_ctd_series_for_plotting(date.min=as.POSIXct("2024-03-01 00:00:00", tz="GMT"), date.max=as.POSIXct("2024-05-15 00:00:00", tz="GMT"))
```
